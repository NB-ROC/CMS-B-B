...
<body>
    ...
    <nav>
        ...
        <a href="reservering.html">Reserveren</a>
    ...
    <main>
        ...
        <h2>Onze Kamers</h2>
        <span class="subtitle"
          >Ontdek onze stijlvol ingerichte kamers, waar comfort en elegantie
          samenkomen.</span
        >
      </div>
      <div class="TwinKamer">
        ...
        <div class="allimages">
          <img
            class="imgTwinKamer"
            src="images/002c3d69-1496-4f82-a20a-f538f8ef7934.avif"
            alt=""
          />
          ...
          <img
            class="imgTwinKamer2"
            src="images/2838a928-5577-4fba-8b79-fd66c04fed90.avif"
            alt=""
          />
          <img
            class="imgTwinKamer2 Rechts"
            src="images/afcf2621-24e9-4f5c-8187-9c7958dafe14.avif"
            alt=""
          />
        </div>
      </div>
