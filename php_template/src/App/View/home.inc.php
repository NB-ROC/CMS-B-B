...
<div class="w-full flex flex-col items-center gap-[50px] p-[30px] pb-[100px]">
    <h2 class="text-[60px]">Faciliteiten</h2>
    <div class="w-[95%] flex flex-row justify-between">
        <div class="flex flex-col gap-[30px]">
            <div class="w-[400px] bg-white rounded-[20px] text-[#ff5656] outline outline-1 outline-[#d2b8b8] flex flex-col gap-[20px] p-[20px] pb-[50px]">
